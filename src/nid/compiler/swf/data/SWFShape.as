package nid.compiler.swf.data
{
	...
	import nid.compiler.swf.data.consts.GradientInterpolationMode;
	import nid.compiler.swf.data.consts.GradientSpreadMode;
	import nid.compiler.swf.data.consts.LineCapsStyle;
	import nid.compiler.swf.data.consts.LineJointStyle;
	import nid.compiler.swf.data.etc.CurvedEdge;
	import nid.compiler.swf.data.etc.IEdge;
	import nid.compiler.swf.data.etc.StraightEdge;
	import nid.compiler.swf.exporters.core.DefaultShapeExporter;
	import nid.compiler.swf.exporters.core.IShapeExporter;
	import nid.compiler.swf.utils.ColorUtils;
	import nid.compiler.swf.utils.NumberUtils;
