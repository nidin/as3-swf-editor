...
{
	import nid.compiler.swf.data.*;
	import nid.compiler.swf.data.actions.IAction;
	import nid.compiler.swf.data.filters.*;
	import nid.compiler.swf.factories.*;
	import nid.compiler.utils.BitArray;
	import nid.compiler.utils.HalfPrecisionWriter;
