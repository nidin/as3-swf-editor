package nid.compiler.swf.tags
{
	...
	import nid.compiler.swf.data.consts.SoundRate;
	import nid.compiler.swf.data.consts.SoundSize;
	import nid.compiler.swf.data.consts.SoundType;
	import nid.compiler.swf.data.etc.MPEGFrame;
