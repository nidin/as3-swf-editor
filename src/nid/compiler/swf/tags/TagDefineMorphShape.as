package nid.compiler.swf.tags
{
	...
	import nid.compiler.swf.data.SWFMorphFillStyle;
	import nid.compiler.swf.data.SWFMorphLineStyle;
	import nid.compiler.swf.data.SWFRectangle;
	import nid.compiler.swf.data.SWFShape;
	import nid.compiler.swf.data.SWFShapeRecord;
	import nid.compiler.swf.data.SWFShapeRecordCurvedEdge;
	import nid.compiler.swf.data.SWFShapeRecordStraightEdge;
	import nid.compiler.swf.data.SWFShapeRecordStyleChange;
