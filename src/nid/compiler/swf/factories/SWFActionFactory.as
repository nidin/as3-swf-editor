package nid.compiler.swf.factories
{
	...
	import nid.compiler.swf.data.actions.swf3.*;
	import nid.compiler.swf.data.actions.swf4.*;
	import nid.compiler.swf.data.actions.swf5.*;
	import nid.compiler.swf.data.actions.swf6.*;
	import nid.compiler.swf.data.actions.swf7.*;
