...
{
	import nid.compiler.swf.data.SWFFrameLabel;
	import nid.compiler.swf.data.SWFRawTag;
	import nid.compiler.swf.data.SWFRecordHeader;
	import nid.compiler.swf.data.SWFScene;
	import nid.compiler.swf.data.consts.SoundCompression;
	import nid.compiler.swf.events.SWFErrorEvent;
	import nid.compiler.swf.events.SWFEvent;
	import nid.compiler.swf.events.SWFEventDispatcher;
	import nid.compiler.swf.factories.ISWFTagFactory;
	import nid.compiler.swf.factories.SWFTagFactory;
	import nid.compiler.swf.tags.IDefinitionTag;
	import nid.compiler.swf.tags.IDisplayListTag;
	import nid.compiler.swf.tags.ITag;
	import nid.compiler.swf.tags.TagDefineMorphShape;
	import nid.compiler.swf.tags.TagDefineSceneAndFrameLabelData;
	import nid.compiler.swf.tags.TagDefineSprite;
	import nid.compiler.swf.tags.TagEnd;
	import nid.compiler.swf.tags.TagFrameLabel;
	import nid.compiler.swf.tags.TagJPEGTables;
	import nid.compiler.swf.tags.TagPlaceObject;
	import nid.compiler.swf.tags.TagPlaceObject2;
	import nid.compiler.swf.tags.TagPlaceObject3;
	import nid.compiler.swf.tags.TagRemoveObject;
	import nid.compiler.swf.tags.TagRemoveObject2;
	import nid.compiler.swf.tags.TagSetBackgroundColor;
	import nid.compiler.swf.tags.TagShowFrame;
	import nid.compiler.swf.tags.TagSoundStreamBlock;
	import nid.compiler.swf.tags.TagSoundStreamHead;
	import nid.compiler.swf.tags.TagSoundStreamHead2;
	import nid.compiler.swf.timeline.Frame;
	import nid.compiler.swf.timeline.FrameObject;
	import nid.compiler.swf.timeline.Layer;
	import nid.compiler.swf.timeline.LayerStrip;
	import nid.compiler.swf.timeline.Scene;
	import nid.compiler.swf.timeline.SoundStream;
