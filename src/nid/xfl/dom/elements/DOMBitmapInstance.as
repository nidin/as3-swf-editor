package nid.xfl.dom.elements 
{
	...
	import flash.geom.*;
	import nid.utils.*;
	import nid.compiler.factory.ElementFactory;
	import nid.compiler.swf.data.consts.BitmapFormat;
	import nid.compiler.swf.data.consts.BitmapType;
	import nid.compiler.swf.data.SWFFillStyle;
	import nid.compiler.swf.data.SWFMatrix;
	import nid.compiler.swf.data.SWFRectangle;
	import nid.compiler.swf.data.SWFShapeRecord;
	import nid.compiler.swf.data.SWFShapeWithStyle;
	import nid.compiler.swf.tags.*;
