...
{
	import nid.compiler.swf.data.filters.FilterBevel;
	import nid.compiler.swf.data.filters.FilterBlur;
	import nid.compiler.swf.data.filters.FilterColorMatrix;
	import nid.compiler.swf.data.filters.FilterConvolution;
	import nid.compiler.swf.data.filters.FilterDropShadow;
	import nid.compiler.swf.data.filters.FilterGlow;
	import nid.compiler.swf.data.filters.FilterGradientBevel;
	import nid.compiler.swf.data.filters.FilterGradientGlow;
	import nid.compiler.swf.data.filters.IFilter;
